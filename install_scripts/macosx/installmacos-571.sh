...
$QMAKE_PATH/macdeployqt $imagedir/$APPNAME.app -verbose=1 -libpath=build
...
cp -pr src/languages_lib/QXmlEditWidget_cs.qm $SHAREDRESOURCES/translations
cp -pr src/languages_lib/SCXML_cs.qm $SHAREDRESOURCES/translations
