...
Section ""
        ...
        File "${QtDir}\plugins\imageformats\qwebpd.dll"
        #File "${QtDir}\plugins\imageformats\qjp2d.dll"
        File "${QtDir}\plugins\imageformats\qicnsd.dll"
        File "${QtDir}\plugins\imageformats\qddsd.dll"
        ...
        File "${SourceDir}\src\languages_lib\SCXML_cs.qm"
