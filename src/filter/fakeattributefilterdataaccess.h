...
#ifndef FAKEATTRIBUTEFILTERDATAACCESS_H
#define FAKEATTRIBUTEFILTERDATAACCESS_H

#include "attributefilterdataaccess.h"

class FakeAttributeFilterDataAccess : public AttributeFilterDataAccess
{
public:
    bool resultToShow;

    FakeAttributeFilterDataAccess();
    ~FakeAttributeFilterDataAccess();
...
#endif // FAKEATTRIBUTEFILTERDATAACCESS_H
