...
SOURCES += $$files(../src/xsdeditor/report/*.cpp)
SOURCES += $$files(../src/config/*.cpp)
SOURCES += $$files(../src/extraction/*.cpp)
SOURCES += $$files(../src/extraction/scripting/*.cpp)
SOURCES += $$files(../src/extraction/scripting/model/*.cpp)
SOURCES += $$files(../src/extraction/scripting/events/*.cpp)
...
SOURCES += $$files(../src/modules/help/*.cpp)
...
HEADERS += $$files(../src/extraction/scripting/*.h)
HEADERS += $$files(../src/extraction/scripting/model/*.h)
HEADERS += $$files(../src/extraction/scripting/events/*.h)
...
HEADERS += $$files(../src/modules/help/*.h)
