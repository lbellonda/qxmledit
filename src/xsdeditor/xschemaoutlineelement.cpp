...
XSchemaOutlineElement::XSchemaOutlineElement(XSchemaObject *newParent, XSchemaRoot *newRoot, const ElementCategory category) : XSchemaObject(newParent, newRoot)
{
...
bool XSchemaOutlineElement::isPredefined() const
{
    return _isPredefined;
}

void XSchemaOutlineElement::setIsPredefined(bool value)
{
    _isPredefined = value ;
}


QString XSchemaOutlineElement::nameOrReference()
{
    if(!name().isEmpty()) {
        return name();
    }
...
bool XSchemaOutlineElement::isTypeOrElement()
{
    return _isTypeOrElement ;
}

bool XSchemaOutlineElement::canAddAttribute()
{
    switch(category()) {
...
bool XSchemaOutlineElement::canAddSequence()
{
    if(category() == XSchemaElement::EES_COMPLEX_DEFINITION) {
        return true ;
    }
    return false ;
}

bool XSchemaOutlineElement::canAddChoice()
{
    if(category() == XSchemaElement::EES_COMPLEX_DEFINITION) {
        return true ;
    }
...
bool XSchemaOutlineElement::canAddRestriction()
{
    switch(_elementCategory) {
    default:
        return false;

    case XSchemaElement::EES_SIMPLETYPE_ONLY:
    case XSchemaElement::EES_SIMPLETYPE_WITHATTRIBUTES:
    case XSchemaElement::EES_COMPLEX_DERIVED:
        return true ; //TODO !hasChild();
    }
}


XSchemaElement::ElementCategory XSchemaOutlineElement::category()
{
    Utils::TODO_THIS_RELEASE("fare");
    return XSchemaElement::EES_EMPTY;
...
/**
  ...
  */
//void XSchemaOutlineElement::setCategory(const XSchemaElement::ElementCategory newCategory)
void XSchemaOutlineElement::setCategory(const XSchemaElement::ElementCategory)
{
    Utils::TODO_THIS_RELEASE("fare");
...
XReferenceType XSchemaOutlineElement::referencedObjectType()
{
...
QString XSchemaOutlineElement::referencedObjectName()
{
    return _ref ;
}
...
QString XSchemaOutlineElement::nameDescr()
{
    QString ownName ;
...
QString XSchemaOutlineElement::simpleComplexDescr()
{
    QString result ;
    switch(_elementCategory) {
    default:
...
QString XSchemaOutlineElement::description()
{
    QString occurrences ;
    if((_minOccurs.isSet) && (_maxOccurs.isSet)) {
        occurrences = QString("%1 .. %2").arg(_minOccurs.toString()).arg(_maxOccurs.toString());
...
void XSchemaOutlineElement::resetAttributes()
{
...
XSchemaAttribute* XSchemaOutlineElement::addAttribute()
{
...
XSchemaElement* XSchemaOutlineElement::addElement()
{
    return realAddElement();
}


XSchemaChoice* XSchemaOutlineElement::addChoice()
{
    return realAddChoice();
}

XSchemaSequence* XSchemaOutlineElement::addSequence()
{
    return realAddSequence();
}

XSchemaObject* XSchemaOutlineElement::addRestriction()
{
    switch(_elementCategory) {
    default:
        return NULL;
...
bool XSchemaOutlineElement::generateDom(QDomDocument &document, QDomNode &parent)
{
    QDomElement node ;
    if(!_isTypeOrElement) {
...
void XSchemaOutlineElement::writeHandleSimpleType(QDomDocument &document, QDomElement &typeSpecifier)
{
...
void XSchemaOutlineElement::writeHandleComplexType(QDomDocument &document, QDomElement &typeSpecifier)
{
    // handles type attributes
...
void XSchemaOutlineElement::writeAppendElementAttributes(QDomDocument &/*document*/, QDomElement &node)
{
    //TODO
...
void XSchemaOutlineElement::writeAppendAttributes(QDomDocument &document, QDomElement &node)
{
...
void XSchemaOutlineElement::writeAppendNotAttributes(QDomDocument &document, QDomElement &node)
{
    foreach(XSchemaObject * child, _children) {
        if(child->getType() != SchemaTypeAttribute) {
...
//----------------------- accessors -----------------
/*
bool XSchemaOutlineElement::abstract()
{
    return _abstract ;
}

void XSchemaOutlineElement::setAbstract(bool newAbstract)
{
...
IMPL_QPROP(XEnums::XBool, XSchemaOutlineElement, abstract, setAbstract, PROPERTY_ELEMENT_ABSTRACT)
IMPL_QPROP(XEnums::XBool, XSchemaOutlineElement, nillable, setNillable, PROPERTY_ELEMENT_NILLABLE)
IMPL_QPROP(XEnums::XBool, XSchemaOutlineElement, mixed, setMixed, PROPERTY_ELEMENT_MIXED)
IMPL_QPROPS(XSchemaOutlineElement, fixed, setFixed, PROPERTY_ELEMENT_FIXED)
IMPL_QPROPS(XSchemaOutlineElement, defaultValue, setDefaultValue, PROPERTY_ELEMENT_DEFAULTVALUE)
// TODO IMPL_QPROP(XOccurrence,XSchemaOutlineElement,maxOccurs,setMaxOccurs,PROPERTY_ELEMENT_MAXOCCURS);
// TODO IMPL_QPROP(XOccurrence,XSchemaOutlineElement,minOccurs,setMinOccurs,PROPERTY_ELEMENT_MINOCCURS);
//TODO IMPL_QPROP(XSchemaOutlineElement::EFinalType, XSchemaOutlineElement, final, setFinal, PROPERTY_ELEMENT_FINAL);
//TODO IMPL_QPROP(XSchemaOutlineElement::EFinalType, XSchemaOutlineElement, block, setBlock, PROPERTY_ELEMENT_BLOCK);
IMPL_QPROPS(XSchemaOutlineElement, xsdType, setXsdType, PROPERTY_ELEMENT_TYPE)
IMPL_QPROPS(XSchemaOutlineElement, ref, setRef, PROPERTY_ELEMENT_REF)
#if 0

IMPL_QPROPS(XSchemaOutlineElement, substitutionGroup, setSubstitutionGroup, PROPERTY_ELEMENT_SUBSTITUTIONGROUP);

#endif


bool XSchemaOutlineElement::isSimpleType()
{
    return (_elementCategory == EES_SIMPLETYPE_ONLY);
}

bool XSchemaOutlineElement::isComplexType()
{
    switch(_elementCategory) {
    default:
        return false;
...
void XSchemaOutlineElement::loadFromDom(XSDLoadContext *loadContext, QDomElement &element)
{
    reset();
...
bool XSchemaOutlineElement::readHandleSimpleType(XSDLoadContext *loadContext, QDomElement &element, const bool isTopLevel)
{
    bool isOk = true ;
...
bool XSchemaOutlineElement::readHandleComplexType(XSDLoadContext *loadContext, QDomElement &element1, const bool isTopLevel)
{
    bool isOk = true ;
...
bool XSchemaOutlineElement::isExtension()
{
...
bool XSchemaOutlineElement::isRestriction()
{
    if(_elementCategory == EES_COMPLEX_DERIVED) {
        if(_children.size() > 0) {
            XSchemaObject *child = _children.at(0);
...
bool XSchemaOutlineElement::isSimpleExtension()
{
...
bool XSchemaOutlineElement::isSimpleRestiction()
{
    if(_elementCategory == EES_SIMPLETYPE_WITHATTRIBUTES) {
        if(_children.size() > 0) {
            XSchemaObject *child = _children.at(0);
...
void XSchemaOutlineElement::validateComplexType(QDomElement &/*element*/, const bool /*isInner*/)
{
    //TODO
}

void XSchemaOutlineElement::readHandleAnnotation(XSDLoadContext *loadContext, QDomElement &element, const bool isInner)
{
    if(!isInner) {
...
XSchemaSimpleContent *XSchemaOutlineElement::readSimpleContentChild(XSDLoadContext *loadContext, QDomElement &element)
{
...
XSchemaComplexContent *XSchemaOutlineElement::readComplexContentChild(XSDLoadContext *loadContext, QDomElement &element)
{
...
bool XSchemaOutlineElement::hasAReference()
{
    return !_ref.isEmpty();
}
...
void XSchemaOutlineElement::reparent(XSchemaObject *newParent)
{
...
QString XSchemaOutlineElement::xmlRepresentation()
{
    Utils::TODO_THIS_RELEASE("fare");
    /*XSchemaXmlRepresentationInfo info;
    XSchemaOutlineElement *elm = NULL ;
    switch(category()) {
    case XSchemaElement::EES_EMPTY:
        elm = resolveType(this);
        break;
    case XSchemaElement::EES_REFERENCE:
        elm = resolveType(resolveReference(this));
        break;
    case XSchemaElement::EES_SIMPLETYPE_ONLY:
    case XSchemaElement::EES_SIMPLETYPE_WITHATTRIBUTES:
    case XSchemaElement::EES_COMPLEX_DERIVED:
    case XSchemaElement::EES_COMPLEX_DEFINITION:
        elm = resolveType(this);
        break;
    default:
        //
...
XSchemaAttributesCollection *XSchemaOutlineElement::attributesRepresentation()
{
    Utils::TODO_THIS_RELEASE("fare");
...
//XSchemaElement *XSchemaOutlineElement::resolveReference(XSchemaElement *base)
XSchemaElement *XSchemaOutlineElement::resolveReference(XSchemaElement *)
{
    Utils::TODO_THIS_RELEASE("fare");
    return NULL;
...
XSchemaElement *XSchemaOutlineElement::resolveType(XSchemaElement *base)
{
    if(NULL == base) {
        return NULL ;
    }
...
XSchemaElement *XSchemaOutlineElement::resolveReference(XSchemaFindReferenceContext &, XSchemaElement *)
//XSchemaElement *XSchemaOutlineElement::resolveReference(XSchemaFindReferenceContext &context, XSchemaElement *base)
{
    Utils::TODO_THIS_RELEASE("fare");
    return NULL;

    /*XSchemaOutlineElement *result = base;
...
XSchemaElement *XSchemaOutlineElement::resolveType(XSchemaFindReferenceContext &context, XSchemaElement *base)
{
    if(NULL == base) {
...
/**
 * @brief XSchemaOutlineElement::collectAttributes
 * @param attributesCollection
 * @param recursive
 * @return  true if all ok.
 */
bool XSchemaOutlineElement::collectAttributes(XSchemaAttributesCollection & attributesCollection)
{
    switch(category()) {
    case EES_EMPTY:
    case EES_SIMPLETYPE_ONLY:
...
XSchemaComplexContentExtension *XSchemaOutlineElement::getExtension()
{
    if(_children.size() > 0) {
        XSchemaObject *child = _children.at(0);
        if(child->getType() == SchemaTypeComplexContentExtension) {
...
XSchemaComplexContentRestriction *XSchemaOutlineElement::getRestriction()
{
    if(_children.size() > 0) {
        XSchemaObject *child = _children.at(0);
        if(child->getType() == SchemaTypeComplexContentRestriction) {
...
XSchemaSimpleContentExtension *XSchemaOutlineElement::getSimpleContentExtension()
{
    if(_children.size() > 0) {
        XSchemaObject *child = _children.at(0);
        if(child->getType() == SchemaTypeSimpleContentExtension) {
...
XSchemaSimpleContentRestriction *XSchemaOutlineElement::getSimpleContentRestriction()
{
    if(_children.size() > 0) {
        XSchemaObject *child = _children.at(0);
        if(child->getType() == SchemaTypeSimpleContentRestriction) {
...
XSchemaSimpleTypeRestriction *XSchemaOutlineElement::getSimpleTypeRestriction()
{
    foreach(XSchemaObject * child, _children) {
...
XSchemaElement *XSchemaOutlineElement::getReferencedType()
{
    Utils::TODO_THIS_RELEASE("fare");
    return NULL ;
    /*Utils::TODO_NEXT_RELEASE("da fare con ricorsione");
    XSchemaOutlineElement *baseTypeOrElement = _root->schema()->topLevelType(referencedObjectName());
    return baseTypeOrElement ;*/
}

XSchemaElement *XSchemaOutlineElement::getReferencedElement()
{
    Utils::TODO_THIS_RELEASE("fare");
    return NULL;
    /*Utils::TODO_NEXT_RELEASE("riferimento qualificato?");
    XSchemaOutlineElement *baseTypeOrElement = _root->schema()->topLevelElement(referencedObjectName());
    return baseTypeOrElement;*/
}

void XSchemaOutlineElement::collectAttributeOfComplexDerived(XSchemaAttributesCollection &)
{
    Utils::TODO_THIS_RELEASE("fare");
    /*XSchemaOutlineElement *baseTypeOrElement ;
    if(!hasAReference()) {
    ...
    if(NULL != restriction) {
        ...
        if(NULL != extension) {
            ...
            XSchemaOutlineElement *extType = extension->getBaseType();
            if(NULL != extType) {
...
//void XSchemaOutlineElement::collectAttributeOfSimpleDerived(XSchemaAttributesCollection & attributesCollection)
void XSchemaOutlineElement::collectAttributeOfSimpleDerived(XSchemaAttributesCollection &)
{
    Utils::TODO_THIS_RELEASE("fare");
    /*XSchemaOutlineElement *baseTypeOrElement ;
    if(!hasAReference()) {
...
void XSchemaOutlineElement::collectAttributesCollection(XSchemaAttributesCollection & attributesCollection)
{
...
void XSchemaOutlineElement::raiseErrorTypesME(XSDLoadContext *loadContext, QDomElement &node)
{
...
void XSchemaOutlineElement::validateAfterRead(XSDLoadContext *loadContext, QDomElement &node, void *context)
{
    // all must be true:
...
void XSchemaOutlineElement::validateAfterReadType(XSDLoadContext *loadContext, QDomElement &node, void * /*context*/)
{
...
void XSchemaOutlineElement::validateAfterReadElement(XSDLoadContext *loadContext, QDomElement &node, void * /*context*/)
{
    // all must be true:
    //1 default and fixed must not both be present.
