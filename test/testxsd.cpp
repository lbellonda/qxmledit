...
bool TestXsd::testAttributes1()
{
    ...
    if(!testAttributesValue(root,
                            XSI_NAMESPACE_COMPLETE, ATTRIBUTE_SCHEMA_NONS_LOCATION,
                            SCHEMA_URI, "***")) {
        result = false ;
    }
    delete regola;
    ...
    root->addAttribute(ATTRIBUTE_SCHEMA_NONS_LOCATION, "x");
    ...
    root->addAttribute(ATTRIBUTE_SCHEMA_NONS_LOCATION, "x");
    root->addAttribute(XSI_NAMESPACE_COMPLETE, "y");
