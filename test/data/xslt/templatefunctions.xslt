...
<xsl:stylesheet version="2.0"
	...
	<xsl:function name="fcdbfgfg" >
	  <xsl:value-of select="'a'"/>
	</xsl:function>
	<xsl:function name="fzfkrjhf" >
	  <xsl:value-of select="'a'"/>
	</xsl:function>
	<xsl:function name="fmgharf" >
	  <xsl:value-of select="'a'"/>
	 </xsl:function>
	<xsl:function name="fabcde" >
	  <xsl:value-of select="'a'"/>
	</xsl:function>
