...
qmake "CONFIG+=release" "QXMLEDIT_INST_DATA_DIR = override_INST_DATA_DIR" \
 "QXMLEDIT_INST_DIR = override_INST_DIR" \
 "QXMLEDIT_INST_DOC_DIR = override_INST_DOC_DIR" \
 "QXMLEDIT_INST_LIB_DIR = override_INST_LIB_DIR" \
 "QXMLEDIT_INST_INCLUDE_DIR = override_INST_INCLUDE_DIR" \
 "QXMLEDIT_INST_TRANSLATIONS_DIR = override_INST_TRANSLATIONS_DIR" \
